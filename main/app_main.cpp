...
#define STEPPER_PIN_IN1  GPIO_NUM_2
#define STEPPER_PIN_IN2  GPIO_NUM_3
#define STEPPER_PIN_IN3  GPIO_NUM_4
#define STEPPER_PIN_IN4  GPIO_NUM_5
...
extern "C" void app_main(void)
{
    ...
    ESP_LOGI(TAG, "  ESP32-C6 GPIO2 -> ULN2003 IN1");
    ESP_LOGI(TAG, "  ESP32-C6 GPIO3 -> ULN2003 IN2");
    ESP_LOGI(TAG, "  ESP32-C6 GPIO4 -> ULN2003 IN3");
    ESP_LOGI(TAG, "  ESP32-C6 GPIO5 -> ULN2003 IN4");
}
